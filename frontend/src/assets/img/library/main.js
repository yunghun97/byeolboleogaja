...
// export default (() => {
	const hand = await document.querySelector('.hand');
	// const hand = document.querySelector('.hand');
	const leaflet = await document.querySelector('.leaflet');
	// const leaflet = document.querySelector('.leaflet');
	const pageElems = await document.querySelectorAll('.page');
	// const pageElems = document.querySelectorAll('.page');

	if (
		hand && leaflet && pageElems
	) {
		let pageCount = 0;
		let currentMenu;
